...
export const BRIDGE_PROGRESS: FlowStep[] = [
  ...
  { label: "寻找对方资源", active: true },
  { label: "检查双方收益" },
  { label: "生成桥的理由" },
];

export const CANDIDATES = [
  { name: "品牌摄影师阿杰", desc: "拍摄空间互换 × 品牌曝光", scoreRange: "92%", tone: "blue" },
  { name: "设计师小林", desc: "空间互换 × 曝光支持", scoreRange: "88%", tone: "green" },
  { name: "创意团队「光合」", desc: "空间互换 × 联合内容共创", scoreRange: "86%", tone: "warm" },
];
