...
const studioPhotography: DemoScenario = {
  ...
  sourceTexts: {
    ...
    "studio-c": "我提供商业品牌摄影，需要室内场地，但只接受现金结算。",
    "studio-d": "我能提供品牌摄影，希望在上海找到下周末的室内工作室。",
  },
  pact: {
...
const productWeb: DemoScenario = {
  ...
  sourceTexts: {
    ...
    "product-c": "我按报价承接网页开发，需要对方先给出清晰的产品方案。",
    "product-d": "我工作日能做网页开发，希望互换产品策划支持。",
  },
  pact: {
...
const ruralContent: DemoScenario = {
  ...
  sourceTexts: {
    ...
    "rural-c": "我们按月费提供内容代运营，也需要适合活动的田园场地。",
    "rural-d": "我们能做田园短视频，希望连接成都近郊的联合创作空间。",
  },
  pact: {
