...
const studioPhotography: DemoScenario = {
  ...
  sourceTexts: {
    ...
    "studio-c": "我提供商业品牌摄影，需要北京朝阳室内场地，可接受场地置换，具体档期待确认。",
    "studio-d": "我可以做半天品牌拍摄，希望找到自然光工作室，交付范围和时间还要再商量。",
    "studio-e": "我主要做活动跟拍和人像写真，希望交换直播或录音空间。",
    "studio-f": "我可以在上海工作日提供品牌摄影，也只需要上海的室内拍摄空间。",
  },
  pact: {
...
const productWeb: DemoScenario = {
  ...
  sourceTexts: {
    ...
    "product-c": "我可用技能互换承接网页开发，需要对方先给出清晰方案，协作档期待确认。",
    "product-d": "我可以做部分网页开发，也需要产品定位支持，具体范围和档期还要商量。",
    "product-e": "我能做运营自动化脚本，希望交换增长运营建议。",
    "product-f": "我可以在线下上海的工作日开发网页，希望获得产品需求支持。",
  },
  pact: {
...
const ruralContent: DemoScenario = {
  ...
  sourceTexts: {
    ...
    "rural-c": "我们可联合运营提供内容服务，也需要适合活动的田园场地，档期待确认。",
    "rural-d": "我们能做田园探店短视频，希望连接可拍摄和短期停留的空间，合作范围待确认。",
    "rural-e": "我们主要做直播探店，希望交换商品供应和佣金合作。",
    "rural-f": "我们只在云南做田园内容，希望连接云南本地空间。",
  },
  pact: {
